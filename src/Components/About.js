            ...
            <div className='diff-rec'>
                <div className='col-1'>
                    ...
                    <div className='sub-exp'>
                        I build my websites to work<br/> on any device, big or small
                    </div>
                ...
                <div className='col-2'>
                    ...
                    <div className='sub-exp'>
                        I like to add some life to<br/> my websites
                    </div>
                ...
                <div className='col-3'>
                    ...
                    <div className='sub-exp'>
                        Emphasis on easy to use<br/> and intuitive UX/UI
                    </div>
